...
export type AnimationLists = keyof typeof AnimationList
export interface AnimationClassChild {
  label: string
  value: string
  pending?: boolean
...
interface AnimationClassItem {
  label: AnimationList
  children: AnimationClassChild[]
}

const animationClassList: AnimationClassItem[] = [
  {
    label: AnimationList.fadeIn,
    children: [
...
animationClassList.forEach((item) => {
