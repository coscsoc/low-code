...
import { getURL, urlRE } from './request'

const methodOptions = ['GET', 'POST', 'PUT', 'DELETE']
const dataOptions = ['object', 'array', 'string']

const globalStore = useGlobalStore()
const request = globalStore.curComponent!.request || {}
...
const addArrayData = () => request.data.push('')

const deleteData = (index: number) => request.data.splice(index, 1)
...
const addData = () => request.data.push(['', ''])
</script>
    ...
    <el-form>
      ...
      <el-form-item label="请求参数">
        ...
        <div v-if="request.paramType === 'array'" class="param-container">
          <p>数据项</p>
          <div v-for="(_, index) in request.data" :key="index" class="div-delete">
            <el-input
