...
export type StyleMap = keyof typeof styleMap
...
export type SelectKey = keyof typeof optionMap
export const selectKey: SelectKey[] = ['textAlign', 'borderStyle', 'verticalAlign']
